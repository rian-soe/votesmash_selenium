...
async function testExistingEmail() {
    ...
    try {
      ...
      logStep("Filling registration form with existing email");
      await driver.findElement(By.id("email")).sendKeys("tester@gmail.com");
      ...
      await driver.findElement(By.name("password_confirmation")).sendKeys("12345678");

      logStep("Submitting registration form");
      await driver.findElement(By.css("button[type='submit']")).click();

      logStep("Verifying existing email error message");
      ...
      const expectedError = "The email has already been taken.";
